...
#define REALTIME_FILEOUT "./Results/electron_broadspectrum_2022_09_19_v20/totalrecordMETAtot_a"

// #define REALTIME_FILEIN "./Input/data80proton/"
// #define REALTIME_FILEOUT "./Results/data80proton_v13_us_a/totalrecordMETAtot"
...
chemReact* combinePhy(int* totalphy, combinePhysics* recorde, int mode, int file_id)
{
    ...
    {
		// if (i < 10) {
		// 	printf("check probabilities %f %f\n", recorde[i].prob1, recorde[i].prob2);
		// 	printf("check base pair index: %d\n", recorde[i].site.y);
		// }
		// if (recorde[i].site.z != -1) {
		// 	printf("something ? %d %d %d %d\n", recorde[i].site.x, recorde[i].site.y, recorde[i].site.z, recorde[i].site.w);
		// }
    ...
    {
		// if (recorde[i].site.z != -1)
		// 	printf("Check modified probabilities: bp:%d p2=%f < p1=%f \n", recorde[i].site.z, recorde[i].prob2, recorde[i].prob1);
